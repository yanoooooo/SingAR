...
public class EffectHandler : MonoBehaviour
{
    ...
    public RectTransform rendererCanvasSize;
    ...
    public void updateTracker(BackgroundData trackerFrameData)
    {
        ...
        test.GetComponent<RectTransform>().anchoredPosition = new Vector2(
            rendererCanvasSize.sizeDelta.x * rendererCanvasSize.localScale.x - skeleton.JointPositions2D[9].X,
            -skeleton.JointPositions2D[9].Y
            );

        Vector2 scaleOffset = new Vector2(rendererCanvasSize.localScale.x + 0.1f, rendererCanvasSize.localScale.y + 0.1f);
        effect.transform.position = Camera.main.ScreenToWorldPoint(new Vector3(
            rendererCanvasSize.sizeDelta.x * scaleOffset.x - skeleton.JointPositions2D[9].X,
            rendererCanvasSize.sizeDelta.y * scaleOffset.y - skeleton.JointPositions2D[9].Y,
            skeleton.JointPositions3D[9].Z
            ));
